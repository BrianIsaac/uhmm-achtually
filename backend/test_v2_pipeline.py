#!/usr/bin/env python3
"""Test script for V2 pipeline components."""
...
async def test_claim_extraction():
    """Test the ClaimExtractorV2 component."""
    print("\n" + "="*60)
    print("Testing ClaimExtractorV2 with PydanticAI")
    print("="*60)
...
async def test_fact_checking():
    """Test the WebFactCheckerV2 component."""
    print("\n" + "="*60)
    print("Testing WebFactCheckerV2 with PydanticAI")
    print("="*60)
